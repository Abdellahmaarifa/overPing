...
import { CannotDetermineGraphQLTypeError, ConflictingDefaultValuesError, GeneratingSchemaError, InterfaceResolveTypeError, MissingSubscriptionTopicsError, UnionResolveTypeError, } from "../errors/index.js";
...
export class SchemaGenerator {
    ...
    static buildTypesInfo(resolvers) {
        this.unionTypesInfo = getMetadataStorage().unions.map(unionMetadata => {
        ...
        this.enumTypesInfo = getMetadataStorage().enums.map(enumMetadata => {
        ...
        this.objectTypesInfo = getMetadataStorage().objectTypes.map(objectType => {
                ...
                type: new GraphQLObjectType({
                    ...
                    fields: () => {
                        ...
                        if (objectType.interfaceClasses) {
                            const implementedInterfaces = getMetadataStorage().interfaceTypes.filter(it => objectType.interfaceClasses.includes(it.target));
        ...
        this.interfaceTypesInfo = getMetadataStorage().interfaceTypes.map(interfaceType => {
                ...
                type: new GraphQLInterfaceType({
                    ...
                    fields: () => {
                        ...
                        if (interfaceType.interfaceClasses) {
                            const implementedInterfacesMetadata = getMetadataStorage().interfaceTypes.filter(it => interfaceType.interfaceClasses.includes(it.target));
                        ...
                        let fields = fieldsMetadata.reduce((fieldsMap, field) => {
                            const fieldResolverMetadata = getMetadataStorage().fieldResolvers.find(resolver => resolver.getObjectType() === field.target &&
        ...
        this.inputTypesInfo = getMetadataStorage().inputTypes.map(inputType => {
    ...
    static buildRootMutationType(resolvers) {
        const mutationsHandlers = this.filterHandlersByResolvers(getMetadataStorage().mutations, resolvers);
    ...
    static buildRootSubscriptionType(resolvers) {
        const subscriptionsHandlers = this.filterHandlersByResolvers(getMetadataStorage().subscriptions, resolvers);
