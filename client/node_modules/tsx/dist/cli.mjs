...
`).split(`
`).map(n=>vr(n,e,u)).join(`
`)}var Lu=t=>Array.from({length:t}).fill("");function Sr(t,e){let u=[],n=0;for(let s of t){let r=0,i=s.map(o=>{var a;let c=(a=e[n])!=null?a:"";n+=1,o.preprocess&&(c=o.preprocess(c)),bu(c)>o.width&&(c=Br(c,o.width,{hard:!0}));let f=c.split(`
`);if(o.postprocess){let{postprocess:l}=o;f=f.map((p,C)=>l.call(o,p,C))}return o.paddingTop&&f.unshift(...Lu(o.paddingTop)),o.paddingBottom&&f.push(...Lu(o.paddingBottom)),f.length>r&&(r=f.length),lt(Me({},o),{lines:f})}),D=[];for(let o=0;o<r;o+=1){let a=i.map(c=>{var f;let l=(f=c.lines[o])!=null?f:"",p=Number.isFinite(c.width)?" ".repeat(c.width-De(l)):"",C=c.paddingLeftString;return c.align==="right"&&(C+=p),C+=l,c.align==="left"&&(C+=p),C+c.paddingRightString}).join("");D.push(a)}u.push(D.join(`
`))}return u.join(`
`)}function $r(t,e){if(!t||t.length===0)return"";let u=Er(t),n=u.length;if(n===0)return"";let{stdoutColumns:s,columns:r}=cr(e);if(r.length>n)throw new Error(`${r.length} columns defined, but only ${n} columns found`);let i=gr(s,r,u);return t.map(D=>Sr(i,D)).join(`
`)}U();var Tr=["<",">","=",">=","<="];function xr(t){if(!Tr.includes(t))throw new TypeError(`Invalid breakpoint operator: ${t}`)}function Or(t){let e=Object.keys(t).map(u=>{let[n,s]=u.split(" ");xr(n);let r=Number.parseInt(s,10);if(Number.isNaN(r))throw new TypeError(`Invalid breakpoint value: ${s}`);let i=t[u];return{operator:n,breakpoint:r,value:i}}).sort((u,n)=>n.breakpoint-u.breakpoint);return u=>{var n;return(n=e.find(({operator:s,breakpoint:r})=>s==="="&&u===r||s===">"&&u>r||s==="<"&&u<r||s===">="&&u>=r||s==="<="&&u<=r))==null?void 0:n.value}}const Nr=t=>t.replace(/[\W_]([a-z\d])?/gi,(e,u)=>u?u.toUpperCase():""),Hr=t=>t.replace(/\B([A-Z])/g,"-$1").toLowerCase(),Pr={"> 80":[{width:"content-width",paddingLeft:2,paddingRight:8},{width:"auto"}],"> 40":[{width:"auto",paddingLeft:2,paddingRight:8,preprocess:t=>t.trim()},{width:"100%",paddingLeft:2,paddingBottom:1}],"> 0":{stdoutColumns:1e3,columns:[{width:"content-width",paddingLeft:2,paddingRight:8},{width:"content-width"}]}};function Lr(t){let e=!1;return{type:"table",data:{tableData:Object.keys(t).sort((u,n)=>u.localeCompare(n)).map(u=>{const n=t[u],s="alias"in n;return s&&(e=!0),{name:u,flag:n,flagFormatted:`--${Hr(u)}`,aliasesEnabled:e,aliasFormatted:s?`-${n.alias}`:void 0}}).map(u=>(u.aliasesEnabled=e,[{type:"flagName",data:u},{type:"flagDescription",data:u}])),tableBreakpoints:Pr}}}const Iu=t=>{var e;return!t||((e=t.version)!=null?e:t.help?t.help.version:void 0)},ku=t=>{var u;const e="parent"in t&&((u=t.parent)==null?void 0:u.name);return(e?`${e} `:"")+t.name};function Ir(t){var n;const e=[];t.name&&e.push(ku(t));const u=(n=Iu(t))!=null?n:"parent"in t&&Iu(t.parent);if(u&&e.push(`v${u}`),e.length!==0)return{id:"name",type:"text",data:`${e.join(" ")}
`}}function kr(t){const{help:e}=t;if(!(!e||!e.description))return{id:"description",type:"text",data:`${e.description}
`}}function Mr(t){var u;const e=t.help||{};if("usage"in e)return e.usage?{id:"usage",type:"section",data:{title:"Usage:",body:Array.isArray(e.usage)?e.usage.join(`
...
`)}}}}function Wr(t){var e;return!("commands"in t)||!((e=t.commands)!=null&&e.length)?void 0:{id:"commands",type:"section",data:{title:"Commands:",body:{type:"table",data:{tableData:t.commands.map(u=>[u.options.name,u.options.help?u.options.help.description:""]),tableOptions:[{width:"content-width",paddingLeft:2,paddingRight:8}]}},indentBody:0}}}function Gr(t){if(!(!t.flags||Object.keys(t.flags).length===0))return{id:"flags",type:"section",data:{title:"Flags:",body:Lr(t.flags),indentBody:0}}}function jr(t){const{help:e}=t;if(!e||!e.examples||e.examples.length===0)return;let{examples:u}=e;if(Array.isArray(u)&&(u=u.join(`
`)),u)return{id:"examples",type:"section",data:{title:"Examples:",body:u}}}function Ur(t){if(!("alias"in t)||!t.alias)return;const{alias:e}=t;return{id:"aliases",type:"section",data:{title:"Aliases:",body:Array.isArray(e)?e.join(", "):e}}}const Kr=t=>[Ir,kr,Mr,Wr,Gr,jr,Ur].map(e=>e(t)).filter(Boolean),Vr=ws.WriteStream.prototype.hasColors();class zr{text(e){return e}bold(e){return Vr?`\x1B[1m${e}\x1B[22m`:e.toLocaleUpperCase()}indentText({text:e,spaces:u}){return e.replace(/^/gm," ".repeat(u))}heading(e){return this.bold(e)}section({title:e,body:u,indentBody:n=2}){return`${(e?`${this.heading(e)}
`:"")+(u?this.indentText({text:this.render(u),spaces:n}):"")}
`}table({tableData:e,tableOptions:u,tableBreakpoints:n}){return $r(e.map(s=>s.map(r=>this.render(r))),n?Or(n):u)}flagParameter(e){return e===Boolean?"":e===String?"<string>":e===Number?"<number>":Array.isArray(e)?this.flagParameter(e[0]):"<value>"}flagOperator(e){return" "}flagName(e){const{flag:u,flagFormatted:n,aliasesEnabled:s,aliasFormatted:r}=e;let i="";if(r?i+=`${r}, `:s&&(i+="    "),i+=n,"placeholder"in u&&typeof u.placeholder=="string")i+=`${this.flagOperator(e)}${u.placeholder}`;else{const D=this.flagParameter("type"in u?u.type:u);D&&(i+=`${this.flagOperator(e)}${D}`)}return i}flagDefault(e){return JSON.stringify(e)}flagDescription({flag:e}){var n;let u="description"in e&&(n=e.description)!=null?n:"";if("default"in e){let{default:s}=e;typeof s=="function"&&(s=s()),s&&(u+=` (default: ${this.flagDefault(s)})`)}return u}render(e){if(typeof e=="string")return e;if(Array.isArray(e))return e.map(u=>this.render(u)).join(`
`);if("type"in e&&this[e.type]){const u=this[e.type];if(typeof u=="function")return u.call(this,e.data)}throw new Error(`Invalid node type: ${JSON.stringify(e)}`)}}const Et=/^[\w.-]+$/,{stringify:J}=JSON,Yr=/[|\\{}()[\]^$+*?.]/;function pt(t){const e=[];let u,n;for(const s of t){if(n)throw new Error(`Invalid parameter: Spread parameter ${J(n)} must be last`);const r=s[0],i=s[s.length-1];let D;if(r==="<"&&i===">"&&(D=!0,u))throw new Error(`Invalid parameter: Required parameter ${J(s)} cannot come after optional parameter ${J(u)}`);if(r==="["&&i==="]"&&(D=!1,u=s),D===void 0)throw new Error(`Invalid parameter: ${J(s)}. Must be wrapped in <> (required parameter) or [] (optional parameter)`);let o=s.slice(1,-1);const a=o.slice(-3)==="...";a&&(n=s,o=o.slice(0,-3));const c=o.match(Yr);if(c)throw new Error(`Invalid parameter: ${J(s)}. Invalid character found ${J(c[0])}`);e.push({name:o,required:D,spread:a})}return e}function Ct(t,e,u,n){for(let s=0;s<e.length;s+=1){const{name:r,required:i,spread:D}=e[s],o=Nr(r);if(o in t)throw new Error(`Invalid parameter: ${J(r)} is used more than once.`);const a=D?u.slice(s):u[s];if(D&&(s=e.length),i&&(!a||D&&a.length===0))return console.error(`Error: Missing required parameter ${J(r)}
`),n(),process.exit(1);t[o]=a}}function qr(t){return t===void 0||t!==!1}function Mu(t,e,u,n){const s={...e.flags},r=e.version;r&&(s.version={type:Boolean,description:"Show version"});const{help:i}=e,D=qr(i);D&&!("help"in s)&&(s.help={type:Boolean,alias:"h",description:"Show help"});const o=_u(s,n,{ignore:e.ignoreArgv}),a=()=>{console.log(e.version)};if(r&&o.flags.version===!0)return a(),process.exit(0);const c=new zr,f=D&&(i!=null&&i.render)?i.render:C=>c.render(C),l=C=>{const F=Kr({...e,...C?{help:C}:{},flags:s});console.log(f(F,c))};if(D&&o.flags.help===!0)return l(),process.exit(0);if(e.parameters){let{parameters:C}=e,F=o._;const A=C.indexOf("--"),B=C.slice(A+1),H=Object.create(null);if(A>-1&&B.length>0){C=C.slice(0,A);const S=o._["--"];F=F.slice(0,-S.length||void 0),Ct(H,pt(C),F,l),Ct(H,pt(B),S,l)}else Ct(H,pt(C),F,l);Object.assign(o._,H)}const p={...o,showVersion:a,showHelp:l};return typeof u=="function"&&u(p),{command:t,...p}}function Xr(t,e){const u=new Map;for(const n of e){const s=[n.options.name],{alias:r}=n.options;r&&(Array.isArray(r)?s.push(...r):s.push(r));for(const i of s){if(u.has(i))throw new Error(`Duplicate command name found: ${J(i)}`);u.set(i,n)}}return u.get(t)}function Wu(t,e,u=process.argv.slice(2)){if(!t)throw new Error("Options is required");if("name"in t&&(!t.name||!Et.test(t.name)))throw new Error(`Invalid script name: ${J(t.name)}`);const n=u[0];if(t.commands&&Et.test(n)){const s=Xr(n,t.commands);if(s)return Mu(s.options.name,{...s.options,parent:t},s.callback,u.slice(1))}return Mu(void 0,t,e,u)}function Qr(t,e){if(!t)throw new Error("Command options are required");const{name:u}=t;if(t.name===void 0)throw new Error("Command name is required");if(!Et.test(u))throw new Error(`Invalid command name ${JSON.stringify(u)}. Command names must be one word.`);return{options:t,callback:e}}var Zr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Jr(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var fe={exports:{}},Ft,Gu;function ei(){if(Gu)return Ft;Gu=1,Ft=n,n.sync=s;var t=ie;function e(r,i){var D=i.pathExt!==void 0?i.pathExt:process.env.PATHEXT;if(!D||(D=D.split(";"),D.indexOf("")!==-1))return!0;for(var o=0;o<D.length;o++){var a=D[o].toLowerCase();if(a&&r.substr(-a.length).toLowerCase()===a)return!0}return!1}function u(r,i,D){return!r.isSymbolicLink()&&!r.isFile()?!1:e(i,D)}function n(r,i,D){t.stat(r,function(o,a){D(o,o?!1:u(a,r,i))})}function s(r,i){return u(t.statSync(r),r,i)}return Ft}var gt,ju;function ti(){if(ju)return gt;ju=1,gt=e,e.sync=u;var t=ie;function e(r,i,D){t.stat(r,function(o,a){D(o,o?!1:n(a,i))})}function u(r,i){return n(t.statSync(r),i)}function n(r,i){return r.isFile()&&s(r,i)}function s(r,i){var D=r.mode,o=r.uid,a=r.gid,c=i.uid!==void 0?i.uid:process.getuid&&process.getuid(),f=i.gid!==void 0?i.gid:process.getgid&&process.getgid(),l=parseInt("100",8),p=parseInt("010",8),C=parseInt("001",8),F=l|p,A=D&C||D&p&&a===f||D&l&&o===c||D&F&&c===0;return A}return gt}var Ge;process.platform==="win32"||Zr.TESTING_WINDOWS?Ge=ei():Ge=ti();var ui=mt;mt.sync=ni;function mt(t,e,u){if(typeof e=="function"&&(u=e,e={}),!u){if(typeof Promise!="function")throw new TypeError("callback not provided");return new Promise(function(n,s){mt(t,e||{},function(r,i){r?s(r):n(i)})})}Ge(t,e||{},function(n,s){n&&(n.code==="EACCES"||e&&e.ignoreErrors)&&(n=null,s=!1),u(n,s)})}function ni(t,e){try{return Ge.sync(t,e||{})}catch(u){if(e&&e.ignoreErrors||u.code==="EACCES")return!1;throw u}}const he=process.platform==="win32"||process.env.OSTYPE==="cygwin"||process.env.OSTYPE==="msys",Uu=K,si=he?";":":",Ku=ui,Vu=t=>Object.assign(new Error(`not found: ${t}`),{code:"ENOENT"}),zu=(t,e)=>{const u=e.colon||si,n=t.match(/\//)||he&&t.match(/\\/)?[""]:[...he?[process.cwd()]:[],...(e.path||process.env.PATH||"").split(u)],s=he?e.pathExt||process.env.PATHEXT||".EXE;.CMD;.BAT;.COM":"",r=he?s.split(u):[""];return he&&t.indexOf(".")!==-1&&r[0]!==""&&r.unshift(""),{pathEnv:n,pathExt:r,pathExtExe:s}},Yu=(t,e,u)=>{typeof e=="function"&&(u=e,e={}),e||(e={});const{pathEnv:n,pathExt:s,pathExtExe:r}=zu(t,e),i=[],D=a=>new Promise((c,f)=>{if(a===n.length)return e.all&&i.length?c(i):f(Vu(t));const l=n[a],p=/^".*"$/.test(l)?l.slice(1,-1):l,C=Uu.join(p,t),F=!p&&/^\.[\\\/]/.test(t)?t.slice(0,2)+C:C;c(o(F,a,0))}),o=(a,c,f)=>new Promise((l,p)=>{if(f===s.length)return l(D(c+1));const C=s[f];Ku(a+C,{pathExt:r},(F,A)=>{if(!F&&A)if(e.all)i.push(a+C);else return l(a+C);return l(o(a,c,f+1))})});return u?D(0).then(a=>u(null,a),u):D(0)},ri=(t,e)=>{e=e||{};const{pathEnv:u,pathExt:n,pathExtExe:s}=zu(t,e),r=[];for(let i=0;i<u.length;i++){const D=u[i],o=/^".*"$/.test(D)?D.slice(1,-1):D,a=Uu.join(o,t),c=!o&&/^\.[\\\/]/.test(t)?t.slice(0,2)+a:a;for(let f=0;f<n.length;f++){const l=c+n[f];try{if(Ku.sync(l,{pathExt:s}))if(e.all)r.push(l);else return l}catch{}}}if(e.all&&r.length)return r;if(e.nothrow)return null;throw Vu(t)};var ii=Yu;Yu.sync=ri;var _t={exports:{}};const qu=(t={})=>{const e=t.env||process.env;return(t.platform||process.platform)!=="win32"?"PATH":Object.keys(e).reverse().find(n=>n.toUpperCase()==="PATH")||"Path"};_t.exports=qu,_t.exports.default=qu;var Di=_t.exports;const Xu=K,oi=ii,ai=Di;function Qu(t,e){const u=t.options.env||process.env,n=process.cwd(),s=t.options.cwd!=null,r=s&&process.chdir!==void 0&&!process.chdir.disabled;if(r)try{process.chdir(t.options.cwd)}catch{}let i;try{i=oi.sync(t.command,{path:u[ai({env:u})],pathExt:e?Xu.delimiter:void 0})}catch{}finally{r&&process.chdir(n)}return i&&(i=Xu.resolve(s?t.options.cwd:"",i)),i}function li(t){return Qu(t)||Qu(t,!0)}var ci=li,At={};const yt=/([()\][%!^"`<>&|;, *?])/g;function fi(t){return t=t.replace(yt,"^$1"),t}function hi(t,e){return t=`${t}`,t=t.replace(/(\\*)"/g,'$1$1\\"'),t=t.replace(/(\\*)$/,"$1$1"),t=`"${t}"`,t=t.replace(yt,"^$1"),e&&(t=t.replace(yt,"^$1")),t}At.command=fi,At.argument=hi;var di=/^#!(.*)/;const Ei=di;var pi=(t="")=>{const e=t.match(Ei);if(!e)return null;const[u,n]=e[0].replace(/#! ?/,"").split(" "),s=u.split("/").pop();return s==="env"?n:n?`${s} ${n}`:s};const wt=ie,Ci=pi;function Fi(t){const u=Buffer.alloc(150);let n;try{n=wt.openSync(t,"r"),wt.readSync(n,u,0,150,0),wt.closeSync(n)}catch{}return Ci(u.toString())}var gi=Fi;const mi=K,Zu=ci,Ju=At,_i=gi,Ai=process.platform==="win32",yi=/\.(?:com|exe)$/i,wi=/node_modules[\\/].bin[\\/][^\\/]+\.cmd$/i;function Ri(t){t.file=Zu(t);const e=t.file&&_i(t.file);return e?(t.args.unshift(t.file),t.command=e,Zu(t)):t.file}function bi(t){if(!Ai)return t;const e=Ri(t),u=!yi.test(e);if(t.options.forceShell||u){const n=wi.test(e);t.command=mi.normalize(t.command),t.command=Ju.command(t.command),t.args=t.args.map(r=>Ju.argument(r,n));const s=[t.command].concat(t.args).join(" ");t.args=["/d","/s","/c",`"${s}"`],t.command=process.env.comspec||"cmd.exe",t.options.windowsVerbatimArguments=!0}return t}function vi(t,e,u){e&&!Array.isArray(e)&&(u=e,e=null),e=e?e.slice(0):[],u=Object.assign({},u);const n={command:t,args:e,options:u,file:void 0,original:{command:t,args:e}};return u.shell?n:bi(n)}var Bi=vi;const Rt=process.platform==="win32";function bt(t,e){return Object.assign(new Error(`${e} ${t.command} ENOENT`),{code:"ENOENT",errno:"ENOENT",syscall:`${e} ${t.command}`,path:t.command,spawnargs:t.args})}function Si(t,e){if(!Rt)return;const u=t.emit;t.emit=function(n,s){if(n==="exit"){const r=en(s,e);if(r)return u.call(t,"error",r)}return u.apply(t,arguments)}}function en(t,e){return Rt&&t===1&&!e.file?bt(e.original,"spawn"):null}function $i(t,e){return Rt&&t===1&&!e.file?bt(e.original,"spawnSync"):null}var Ti={hookChildProcess:Si,verifyENOENT:en,verifyENOENTSync:$i,notFoundError:bt};const tn=Ss,vt=Bi,Bt=Ti;function un(t,e,u){const n=vt(t,e,u),s=tn.spawn(n.command,n.args,n.options);return Bt.hookChildProcess(s,n),s}function xi(t,e,u){const n=vt(t,e,u),s=tn.spawnSync(n.command,n.args,n.options);return s.error=s.error||Bt.verifyENOENTSync(s.status,n),s}fe.exports=un,fe.exports.spawn=un,fe.exports.sync=xi,fe.exports._parse=vt,fe.exports._enoent=Bt;var Oi=fe.exports,Ni=Jr(Oi);const nn=(t,e)=>{const u={...process.env},n=["inherit","inherit","inherit","ipc"];return e&&(e.noCache&&(u.TSX_DISABLE_CACHE="1"),e.tsconfigPath&&(u.TSX_TSCONFIG_PATH=e.tsconfigPath)),Ni(process.execPath,["--require",at.resolve("./preflight.cjs"),$s?"--import":"--loader",vs(at.resolve("./loader.mjs")).toString(),...t],{stdio:n,env:u})};var je={};const Hi=K,ee="\\\\/",sn=`[^${ee}]`,te="\\.",Pi="\\+",Li="\\?",Ue="\\/",Ii="(?=.)",rn="[^/]",St=`(?:${Ue}|$)`,Dn=`(?:^|${Ue})`,$t=`${te}{1,2}${St}`,ki=`(?!${te})`,Mi=`(?!${Dn}${$t})`,Wi=`(?!${te}{0,1}${St})`,Gi=`(?!${$t})`,ji=`[^.${Ue}]`,Ui=`${rn}*?`,on={DOT_LITERAL:te,PLUS_LITERAL:Pi,QMARK_LITERAL:Li,SLASH_LITERAL:Ue,ONE_CHAR:Ii,QMARK:rn,END_ANCHOR:St,DOTS_SLASH:$t,NO_DOT:ki,NO_DOTS:Mi,NO_DOT_SLASH:Wi,NO_DOTS_SLASH:Gi,QMARK_NO_DOT:ji,STAR:Ui,START_ANCHOR:Dn},Ki={...on,SLASH_LITERAL:`[${ee}]`,QMARK:sn,STAR:`${sn}*?`,DOTS_SLASH:`${te}{1,2}(?:[${ee}]|$)`,NO_DOT:`(?!${te})`,NO_DOTS:`(?!(?:^|[${ee}])${te}{1,2}(?:[${ee}]|$))`,NO_DOT_SLASH:`(?!${te}{0,1}(?:[${ee}]|$))`,NO_DOTS_SLASH:`(?!${te}{1,2}(?:[${ee}]|$))`,QMARK_NO_DOT:`[^.${ee}]`,START_ANCHOR:`(?:^|[${ee}])`,END_ANCHOR:`(?:[${ee}]|$)`},Vi={alnum:"a-zA-Z0-9",alpha:"a-zA-Z",ascii:"\\x00-\\x7F",blank:" \\t",cntrl:"\\x00-\\x1F\\x7F",digit:"0-9",graph:"\\x21-\\x7E",lower:"a-z",print:"\\x20-\\x7E ",punct:"\\-!\"#$%&'()\\*+,./:;<=>?@[\\]^_`{|}~",space:" \\t\\r\\n\\v\\f",upper:"A-Z",word:"A-Za-z0-9_",xdigit:"A-Fa-f0-9"};var Ke={MAX_LENGTH:1024*64,POSIX_REGEX_SOURCE:Vi,REGEX_BACKSLASH:/\\(?![*+?^${}(|)[\]])/g,REGEX_NON_SPECIAL_CHARS:/^[^@![\].,$*+?^{}()|\\/]+/,REGEX_SPECIAL_CHARS:/[-*+?.^${}(|)[\]]/,REGEX_SPECIAL_CHARS_BACKREF:/(\\?)((\W)(\3*))/g,REGEX_SPECIAL_CHARS_GLOBAL:/([-*+?.^${}(|)[\]])/g,REGEX_REMOVE_BACKSLASH:/(?:\[.*?[^\\]\]|\\(?=.))/g,REPLACEMENTS:{"***":"*","**/**":"**","**/**/**":"**"},CHAR_0:48,CHAR_9:57,CHAR_UPPERCASE_A:65,CHAR_LOWERCASE_A:97,CHAR_UPPERCASE_Z:90,CHAR_LOWERCASE_Z:122,CHAR_LEFT_PARENTHESES:40,CHAR_RIGHT_PARENTHESES:41,CHAR_ASTERISK:42,CHAR_AMPERSAND:38,CHAR_AT:64,CHAR_BACKWARD_SLASH:92,CHAR_CARRIAGE_RETURN:13,CHAR_CIRCUMFLEX_ACCENT:94,CHAR_COLON:58,CHAR_COMMA:44,CHAR_DOT:46,CHAR_DOUBLE_QUOTE:34,CHAR_EQUAL:61,CHAR_EXCLAMATION_MARK:33,CHAR_FORM_FEED:12,CHAR_FORWARD_SLASH:47,CHAR_GRAVE_ACCENT:96,CHAR_HASH:35,CHAR_HYPHEN_MINUS:45,CHAR_LEFT_ANGLE_BRACKET:60,CHAR_LEFT_CURLY_BRACE:123,CHAR_LEFT_SQUARE_BRACKET:91,CHAR_LINE_FEED:10,CHAR_NO_BREAK_SPACE:160,CHAR_PERCENT:37,CHAR_PLUS:43,CHAR_QUESTION_MARK:63,CHAR_RIGHT_ANGLE_BRACKET:62,CHAR_RIGHT_CURLY_BRACE:125,CHAR_RIGHT_SQUARE_BRACKET:93,CHAR_SEMICOLON:59,CHAR_SINGLE_QUOTE:39,CHAR_SPACE:32,CHAR_TAB:9,CHAR_UNDERSCORE:95,CHAR_VERTICAL_LINE:124,CHAR_ZERO_WIDTH_NOBREAK_SPACE:65279,SEP:Hi.sep,extglobChars(t){return{"!":{type:"negate",open:"(?:(?!(?:",close:`))${t.STAR})`},"?":{type:"qmark",open:"(?:",close:")?"},"+":{type:"plus",open:"(?:",close:")+"},"*":{type:"star",open:"(?:",close:")*"},"@":{type:"at",open:"(?:",close:")"}}},globChars(t){return t===!0?Ki:on}};(function(t){const e=K,u=process.platform==="win32",{REGEX_BACKSLASH:n,REGEX_REMOVE_BACKSLASH:s,REGEX_SPECIAL_CHARS:r,REGEX_SPECIAL_CHARS_GLOBAL:i}=Ke;t.isObject=D=>D!==null&&typeof D=="object"&&!Array.isArray(D),t.hasRegexChars=D=>r.test(D),t.isRegexChar=D=>D.length===1&&t.hasRegexChars(D),t.escapeRegex=D=>D.replace(i,"\\$1"),t.toPosixSlashes=D=>D.replace(n,"/"),t.removeBackslashes=D=>D.replace(s,o=>o==="\\"?"":o),t.supportsLookbehinds=()=>{const D=process.version.slice(1).split(".").map(Number);return D.length===3&&D[0]>=9||D[0]===8&&D[1]>=10},t.isWindows=D=>D&&typeof D.windows=="boolean"?D.windows:u===!0||e.sep==="\\",t.escapeLast=(D,o,a)=>{const c=D.lastIndexOf(o,a);return c===-1?D:D[c-1]==="\\"?t.escapeLast(D,o,c-1):`${D.slice(0,c)}\\${D.slice(c)}`},t.removePrefix=(D,o={})=>{let a=D;return a.startsWith("./")&&(a=a.slice(2),o.prefix="./"),a},t.wrapOutput=(D,o={},a={})=>{const c=a.contains?"":"^",f=a.contains?"":"$";let l=`${c}(?:${D})${f}`;return o.negated===!0&&(l=`(?:^(?!${l}).*$)`),l}})(je);const an=je,{CHAR_ASTERISK:Tt,CHAR_AT:zi,CHAR_BACKWARD_SLASH:ye,CHAR_COMMA:Yi,CHAR_DOT:xt,CHAR_EXCLAMATION_MARK:Ot,CHAR_FORWARD_SLASH:ln,CHAR_LEFT_CURLY_BRACE:Nt,CHAR_LEFT_PARENTHESES:Ht,CHAR_LEFT_SQUARE_BRACKET:qi,CHAR_PLUS:Xi,CHAR_QUESTION_MARK:cn,CHAR_RIGHT_CURLY_BRACE:Qi,CHAR_RIGHT_PARENTHESES:fn,CHAR_RIGHT_SQUARE_BRACKET:Zi}=Ke,hn=t=>t===ln||t===ye,dn=t=>{t.isPrefix!==!0&&(t.depth=t.isGlobstar?1/0:1)},Ji=(t,e)=>{const u=e||{},n=t.length-1,s=u.parts===!0||u.scanToEnd===!0,r=[],i=[],D=[];let o=t,a=-1,c=0,f=0,l=!1,p=!1,C=!1,F=!1,A=!1,B=!1,H=!1,S=!1,X=!1,M=!1,ne=0,W,_,b={value:"",depth:0,isGlob:!1};const k=()=>a>=n,E=()=>o.charCodeAt(a+1),x=()=>(W=_,o.charCodeAt(++a));for(;a<n;){_=x();let G;if(_===ye){H=b.backslashes=!0,_=x(),_===Nt&&(B=!0);continue}if(B===!0||_===Nt){for(ne++;k()!==!0&&(_=x());){if(_===ye){H=b.backslashes=!0,x();continue}if(_===Nt){ne++;continue}if(B!==!0&&_===xt&&(_=x())===xt){if(l=b.isBrace=!0,C=b.isGlob=!0,M=!0,s===!0)continue;break}if(B!==!0&&_===Yi){if(l=b.isBrace=!0,C=b.isGlob=!0,M=!0,s===!0)continue;break}if(_===Qi&&(ne--,ne===0)){B=!1,l=b.isBrace=!0,M=!0;break}}if(s===!0)continue;break}if(_===ln){if(r.push(a),i.push(b),b={value:"",depth:0,isGlob:!1},M===!0)continue;if(W===xt&&a===c+1){c+=2;continue}f=a+1;continue}if(u.noext!==!0&&(_===Xi||_===zi||_===Tt||_===cn||_===Ot)===!0&&E()===Ht){if(C=b.isGlob=!0,F=b.isExtglob=!0,M=!0,_===Ot&&a===c&&(X=!0),s===!0){for(;k()!==!0&&(_=x());){if(_===ye){H=b.backslashes=!0,_=x();continue}if(_===fn){C=b.isGlob=!0,M=!0;break}}continue}break}if(_===Tt){if(W===Tt&&(A=b.isGlobstar=!0),C=b.isGlob=!0,M=!0,s===!0)continue;break}if(_===cn){if(C=b.isGlob=!0,M=!0,s===!0)continue;break}if(_===qi){for(;k()!==!0&&(G=x());){if(G===ye){H=b.backslashes=!0,x();continue}if(G===Zi){p=b.isBracket=!0,C=b.isGlob=!0,M=!0;break}}if(s===!0)continue;break}if(u.nonegate!==!0&&_===Ot&&a===c){S=b.negated=!0,c++;continue}if(u.noparen!==!0&&_===Ht){if(C=b.isGlob=!0,s===!0){for(;k()!==!0&&(_=x());){if(_===Ht){H=b.backslashes=!0,_=x();continue}if(_===fn){M=!0;break}}continue}break}if(C===!0){if(M=!0,s===!0)continue;break}}u.noext===!0&&(F=!1,C=!1);let $=o,se="",h="";c>0&&(se=o.slice(0,c),o=o.slice(c),f-=c),$&&C===!0&&f>0?($=o.slice(0,f),h=o.slice(f)):C===!0?($="",h=o):$=o,$&&$!==""&&$!=="/"&&$!==o&&hn($.charCodeAt($.length-1))&&($=$.slice(0,-1)),u.unescape===!0&&(h&&(h=an.removeBackslashes(h)),$&&H===!0&&($=an.removeBackslashes($)));const d={prefix:se,input:t,start:c,base:$,glob:h,isBrace:l,isBracket:p,isGlob:C,isExtglob:F,isGlobstar:A,negated:S,negatedExtglob:X};if(u.tokens===!0&&(d.maxDepth=0,hn(_)||i.push(b),d.tokens=i),u.parts===!0||u.tokens===!0){let G;for(let R=0;R<r.length;R++){const Q=G?G+1:c,Z=r[R],V=t.slice(Q,Z);u.tokens&&(R===0&&c!==0?(i[R].isPrefix=!0,i[R].value=se):i[R].value=V,dn(i[R]),d.maxDepth+=i[R].depth),(R!==0||V!=="")&&D.push(V),G=Z}if(G&&G+1<t.length){const R=t.slice(G+1);D.push(R),u.tokens&&(i[i.length-1].value=R,dn(i[i.length-1]),d.maxDepth+=i[i.length-1].depth)}d.slashes=r,d.parts=D}return d};var eD=Ji;const Ve=Ke,z=je,{MAX_LENGTH:ze,POSIX_REGEX_SOURCE:tD,REGEX_NON_SPECIAL_CHARS:uD,REGEX_SPECIAL_CHARS_BACKREF:nD,REPLACEMENTS:En}=Ve,sD=(t,e)=>{if(typeof e.expandRange=="function")return e.expandRange(...t,e);t.sort();const u=`[${t.join("-")}]`;try{new RegExp(u)}catch{return t.map(s=>z.escapeRegex(s)).join("..")}return u},de=(t,e)=>`Missing ${t}: "${e}" - use "\\\\${e}" to match literal characters`,Pt=(t,e)=>{if(typeof t!="string")throw new TypeError("Expected a string");t=En[t]||t;const u={...e},n=typeof u.maxLength=="number"?Math.min(ze,u.maxLength):ze;let s=t.length;if(s>n)throw new SyntaxError(`Input length: ${s}, exceeds maximum allowed length: ${n}`);const r={type:"bos",value:"",output:u.prepend||""},i=[r],D=u.capture?"":"?:",o=z.isWindows(e),a=Ve.globChars(o),c=Ve.extglobChars(a),{DOT_LITERAL:f,PLUS_LITERAL:l,SLASH_LITERAL:p,ONE_CHAR:C,DOTS_SLASH:F,NO_DOT:A,NO_DOT_SLASH:B,NO_DOTS_SLASH:H,QMARK:S,QMARK_NO_DOT:X,STAR:M,START_ANCHOR:ne}=a,W=m=>`(${D}(?:(?!${ne}${m.dot?F:f}).)*?)`,_=u.dot?"":A,b=u.dot?S:X;let k=u.bash===!0?W(u):M;u.capture&&(k=`(${k})`),typeof u.noext=="boolean"&&(u.noextglob=u.noext);const E={input:t,index:-1,start:0,dot:u.dot===!0,consumed:"",output:"",prefix:"",backtrack:!1,negated:!1,brackets:0,braces:0,parens:0,quotes:0,globstar:!1,tokens:i};t=z.removePrefix(t,E),s=t.length;const x=[],$=[],se=[];let h=r,d;const G=()=>E.index===s-1,R=E.peek=(m=1)=>t[E.index+m],Q=E.advance=()=>t[++E.index]||"",Z=()=>t.slice(E.index+1),V=(m="",T=0)=>{E.consumed+=m,E.index+=T},Ne=m=>{E.output+=m.output!=null?m.output:m.value,V(m.value)},As=()=>{let m=1;for(;R()==="!"&&(R(2)!=="("||R(3)==="?");)Q(),E.start++,m++;return m%2===0?!1:(E.negated=!0,E.start++,!0)},He=m=>{E[m]++,se.push(m)},re=m=>{E[m]--,se.pop()},w=m=>{if(h.type==="globstar"){const T=E.braces>0&&(m.type==="comma"||m.type==="brace"),g=m.extglob===!0||x.length&&(m.type==="pipe"||m.type==="paren");m.type!=="slash"&&m.type!=="paren"&&!T&&!g&&(E.output=E.output.slice(0,-h.output.length),h.type="star",h.value="*",h.output=k,E.output+=h.output)}if(x.length&&m.type!=="paren"&&(x[x.length-1].inner+=m.value),(m.value||m.output)&&Ne(m),h&&h.type==="text"&&m.type==="text"){h.value+=m.value,h.output=(h.output||"")+m.value;return}m.prev=h,i.push(m),h=m},Pe=(m,T)=>{const g={...c[T],conditions:1,inner:""};g.prev=h,g.parens=E.parens,g.output=E.output;const y=(u.capture?"(":"")+g.open;He("parens"),w({type:m,value:T,output:E.output?"":C}),w({type:"paren",extglob:!0,value:Q(),output:y}),x.push(g)},ys=m=>{let T=m.close+(u.capture?")":""),g;if(m.type==="negate"){let y=k;if(m.inner&&m.inner.length>1&&m.inner.includes("/")&&(y=W(u)),(y!==k||G()||/^\)+$/.test(Z()))&&(T=m.close=`)$))${y}`),m.inner.includes("*")&&(g=Z())&&/^\.[^\\/.]+$/.test(g)){const O=Pt(g,{...e,fastpaths:!1}).output;T=m.close=`)${O})${y})`}m.prev.type==="bos"&&(E.negatedExtglob=!0)}w({type:"paren",extglob:!0,value:d,output:T}),re("parens")};if(u.fastpaths!==!1&&!/(^[*!]|[/()[\]{}"])/.test(t)){let m=!1,T=t.replace(nD,(g,y,O,j,P,ot)=>j==="\\"?(m=!0,g):j==="?"?y?y+j+(P?S.repeat(P.length):""):ot===0?b+(P?S.repeat(P.length):""):S.repeat(O.length):j==="."?f.repeat(O.length):j==="*"?y?y+j+(P?k:""):k:y?g:`\\${g}`);return m===!0&&(u.unescape===!0?T=T.replace(/\\/g,""):T=T.replace(/\\+/g,g=>g.length%2===0?"\\\\":g?"\\":"")),T===t&&u.contains===!0?(E.output=t,E):(E.output=z.wrapOutput(T,E,e),E)}for(;!G();){if(d=Q(),d==="\0")continue;if(d==="\\"){const g=R();if(g==="/"&&u.bash!==!0||g==="."||g===";")continue;if(!g){d+="\\",w({type:"text",value:d});continue}const y=/^\\+/.exec(Z());let O=0;if(y&&y[0].length>2&&(O=y[0].length,E.index+=O,O%2!==0&&(d+="\\")),u.unescape===!0?d=Q():d+=Q(),E.brackets===0){w({type:"text",value:d});continue}}if(E.brackets>0&&(d!=="]"||h.value==="["||h.value==="[^")){if(u.posix!==!1&&d===":"){const g=h.value.slice(1);if(g.includes("[")&&(h.posix=!0,g.includes(":"))){const y=h.value.lastIndexOf("["),O=h.value.slice(0,y),j=h.value.slice(y+2),P=tD[j];if(P){h.value=O+P,E.backtrack=!0,Q(),!r.output&&i.indexOf(h)===1&&(r.output=C);continue}}}(d==="["&&R()!==":"||d==="-"&&R()==="]")&&(d=`\\${d}`),d==="]"&&(h.value==="["||h.value==="[^")&&(d=`\\${d}`),u.posix===!0&&d==="!"&&h.value==="["&&(d="^"),h.value+=d,Ne({value:d});continue}if(E.quotes===1&&d!=='"'){d=z.escapeRegex(d),h.value+=d,Ne({value:d});continue}if(d==='"'){E.quotes=E.quotes===1?0:1,u.keepQuotes===!0&&w({type:"text",value:d});continue}if(d==="("){He("parens"),w({type:"paren",value:d});continue}if(d===")"){if(E.parens===0&&u.strictBrackets===!0)throw new SyntaxError(de("opening","("));const g=x[x.length-1];if(g&&E.parens===g.parens+1){ys(x.pop());continue}w({type:"paren",value:d,output:E.parens?")":"\\)"}),re("parens");continue}if(d==="["){if(u.nobracket===!0||!Z().includes("]")){if(u.nobracket!==!0&&u.strictBrackets===!0)throw new SyntaxError(de("closing","]"));d=`\\${d}`}else He("brackets");w({type:"bracket",value:d});continue}if(d==="]"){if(u.nobracket===!0||h&&h.type==="bracket"&&h.value.length===1){w({type:"text",value:d,output:`\\${d}`});continue}if(E.brackets===0){if(u.strictBrackets===!0)throw new SyntaxError(de("opening","["));w({type:"text",value:d,output:`\\${d}`});continue}re("brackets");const g=h.value.slice(1);if(h.posix!==!0&&g[0]==="^"&&!g.includes("/")&&(d=`/${d}`),h.value+=d,Ne({value:d}),u.literalBrackets===!1||z.hasRegexChars(g))continue;const y=z.escapeRegex(h.value);if(E.output=E.output.slice(0,-h.value.length),u.literalBrackets===!0){E.output+=y,h.value=y;continue}h.value=`(${D}${y}|${h.value})`,E.output+=h.value;continue}if(d==="{"&&u.nobrace!==!0){He("braces");const g={type:"brace",value:d,output:"(",outputIndex:E.output.length,tokensIndex:E.tokens.length};$.push(g),w(g);continue}if(d==="}"){const g=$[$.length-1];if(u.nobrace===!0||!g){w({type:"text",value:d,output:d});continue}let y=")";if(g.dots===!0){const O=i.slice(),j=[];for(let P=O.length-1;P>=0&&(i.pop(),O[P].type!=="brace");P--)O[P].type!=="dots"&&j.unshift(O[P].value);y=sD(j,u),E.backtrack=!0}if(g.comma!==!0&&g.dots!==!0){const O=E.output.slice(0,g.outputIndex),j=E.tokens.slice(g.tokensIndex);g.value=g.output="\\{",d=y="\\}",E.output=O;for(const P of j)E.output+=P.output||P.value}w({type:"brace",value:d,output:y}),re("braces"),$.pop();continue}if(d==="|"){x.length>0&&x[x.length-1].conditions++,w({type:"text",value:d});continue}if(d===","){let g=d;const y=$[$.length-1];y&&se[se.length-1]==="braces"&&(y.comma=!0,g="|"),w({type:"comma",value:d,output:g});continue}if(d==="/"){if(h.type==="dot"&&E.index===E.start+1){E.start=E.index+1,E.consumed="",E.output="",i.pop(),h=r;continue}w({type:"slash",value:d,output:p});continue}if(d==="."){if(E.braces>0&&h.type==="dot"){h.value==="."&&(h.output=f);const g=$[$.length-1];h.type="dots",h.output+=d,h.value+=d,g.dots=!0;continue}if(E.braces+E.parens===0&&h.type!=="bos"&&h.type!=="slash"){w({type:"text",value:d,output:f});continue}w({type:"dot",value:d,output:f});continue}if(d==="?"){if(!(h&&h.value==="(")&&u.noextglob!==!0&&R()==="("&&R(2)!=="?"){Pe("qmark",d);continue}if(h&&h.type==="paren"){const y=R();let O=d;if(y==="<"&&!z.supportsLookbehinds())throw new Error("Node.js v10 or higher is required for regex lookbehinds");(h.value==="("&&!/[!=<:]/.test(y)||y==="<"&&!/<([!=]|\w+>)/.test(Z()))&&(O=`\\${d}`),w({type:"text",value:d,output:O});continue}if(u.dot!==!0&&(h.type==="slash"||h.type==="bos")){w({type:"qmark",value:d,output:X});continue}w({type:"qmark",value:d,output:S});continue}if(d==="!"){if(u.noextglob!==!0&&R()==="("&&(R(2)!=="?"||!/[!=<:]/.test(R(3)))){Pe("negate",d);continue}if(u.nonegate!==!0&&E.index===0){As();continue}}if(d==="+"){if(u.noextglob!==!0&&R()==="("&&R(2)!=="?"){Pe("plus",d);continue}if(h&&h.value==="("||u.regex===!1){w({type:"plus",value:d,output:l});continue}if(h&&(h.type==="bracket"||h.type==="paren"||h.type==="brace")||E.parens>0){w({type:"plus",value:d});continue}w({type:"plus",value:l});continue}if(d==="@"){if(u.noextglob!==!0&&R()==="("&&R(2)!=="?"){w({type:"at",extglob:!0,value:d,output:""});continue}w({type:"text",value:d});continue}if(d!=="*"){(d==="$"||d==="^")&&(d=`\\${d}`);const g=uD.exec(Z());g&&(d+=g[0],E.index+=g[0].length),w({type:"text",value:d});continue}if(h&&(h.type==="globstar"||h.star===!0)){h.type="star",h.star=!0,h.value+=d,h.output=k,E.backtrack=!0,E.globstar=!0,V(d);continue}let m=Z();if(u.noextglob!==!0&&/^\([^?]/.test(m)){Pe("star",d);continue}if(h.type==="star"){if(u.noglobstar===!0){V(d);continue}const g=h.prev,y=g.prev,O=g.type==="slash"||g.type==="bos",j=y&&(y.type==="star"||y.type==="globstar");if(u.bash===!0&&(!O||m[0]&&m[0]!=="/")){w({type:"star",value:d,output:""});continue}const P=E.braces>0&&(g.type==="comma"||g.type==="brace"),ot=x.length&&(g.type==="pipe"||g.type==="paren");if(!O&&g.type!=="paren"&&!P&&!ot){w({type:"star",value:d,output:""});continue}for(;m.slice(0,3)==="/**";){const Le=t[E.index+4];if(Le&&Le!=="/")break;m=m.slice(3),V("/**",3)}if(g.type==="bos"&&G()){h.type="globstar",h.value+=d,h.output=W(u),E.output=h.output,E.globstar=!0,V(d);continue}if(g.type==="slash"&&g.prev.type!=="bos"&&!j&&G()){E.output=E.output.slice(0,-(g.output+h.output).length),g.output=`(?:${g.output}`,h.type="globstar",h.output=W(u)+(u.strictSlashes?")":"|$)"),h.value+=d,E.globstar=!0,E.output+=g.output+h.output,V(d);continue}if(g.type==="slash"&&g.prev.type!=="bos"&&m[0]==="/"){const Le=m[1]!==void 0?"|$":"";E.output=E.output.slice(0,-(g.output+h.output).length),g.output=`(?:${g.output}`,h.type="globstar",h.output=`${W(u)}${p}|${p}${Le})`,h.value+=d,E.output+=g.output+h.output,E.globstar=!0,V(d+Q()),w({type:"slash",value:"/",output:""});continue}if(g.type==="bos"&&m[0]==="/"){h.type="globstar",h.value+=d,h.output=`(?:^|${p}|${W(u)}${p})`,E.output=h.output,E.globstar=!0,V(d+Q()),w({type:"slash",value:"/",output:""});continue}E.output=E.output.slice(0,-h.output.length),h.type="globstar",h.output=W(u),h.value+=d,E.output+=h.output,E.globstar=!0,V(d);continue}const T={type:"star",value:d,output:k};if(u.bash===!0){T.output=".*?",(h.type==="bos"||h.type==="slash")&&(T.output=_+T.output),w(T);continue}if(h&&(h.type==="bracket"||h.type==="paren")&&u.regex===!0){T.output=d,w(T);continue}(E.index===E.start||h.type==="slash"||h.type==="dot")&&(h.type==="dot"?(E.output+=B,h.output+=B):u.dot===!0?(E.output+=H,h.output+=H):(E.output+=_,h.output+=_),R()!=="*"&&(E.output+=C,h.output+=C)),w(T)}for(;E.brackets>0;){if(u.strictBrackets===!0)throw new SyntaxError(de("closing","]"));E.output=z.escapeLast(E.output,"["),re("brackets")}for(;E.parens>0;){if(u.strictBrackets===!0)throw new SyntaxError(de("closing",")"));E.output=z.escapeLast(E.output,"("),re("parens")}for(;E.braces>0;){if(u.strictBrackets===!0)throw new SyntaxError(de("closing","}"));E.output=z.escapeLast(E.output,"{"),re("braces")}if(u.strictSlashes!==!0&&(h.type==="star"||h.type==="bracket")&&w({type:"maybe_slash",value:"",output:`${p}?`}),E.backtrack===!0){E.output="";for(const m of E.tokens)E.output+=m.output!=null?m.output:m.value,m.suffix&&(E.output+=m.suffix)}return E};Pt.fastpaths=(t,e)=>{const u={...e},n=typeof u.maxLength=="number"?Math.min(ze,u.maxLength):ze,s=t.length;if(s>n)throw new SyntaxError(`Input length: ${s}, exceeds maximum allowed length: ${n}`);t=En[t]||t;const r=z.isWindows(e),{DOT_LITERAL:i,SLASH_LITERAL:D,ONE_CHAR:o,DOTS_SLASH:a,NO_DOT:c,NO_DOTS:f,NO_DOTS_SLASH:l,STAR:p,START_ANCHOR:C}=Ve.globChars(r),F=u.dot?f:c,A=u.dot?l:c,B=u.capture?"":"?:",H={negated:!1,prefix:""};let S=u.bash===!0?".*?":p;u.capture&&(S=`(${S})`);const X=_=>_.noglobstar===!0?S:`(${B}(?:(?!${C}${_.dot?a:i}).)*?)`,M=_=>{switch(_){case"*":return`${F}${o}${S}`;case".*":return`${i}${o}${S}`;case"*.*":return`${F}${S}${i}${o}${S}`;case"*/*":return`${F}${S}${D}${o}${A}${S}`;case"**":return F+X(u);case"**/*":return`(?:${F}${X(u)}${D})?${A}${o}${S}`;case"**/*.*":return`(?:${F}${X(u)}${D})?${A}${S}${i}${o}${S}`;case"**/.*":return`(?:${F}${X(u)}${D})?${i}${o}${S}`;default:{const b=/^(.*?)\.(\w+)$/.exec(_);if(!b)return;const k=M(b[1]);return k?k+i+b[2]:void 0}}},ne=z.removePrefix(t,H);let W=M(ne);return W&&u.strictSlashes!==!0&&(W+=`${D}?`),W};var rD=Pt;const iD=K,DD=eD,Lt=rD,It=je,oD=Ke,aD=t=>t&&typeof t=="object"&&!Array.isArray(t),N=(t,e,u=!1)=>{if(Array.isArray(t)){const c=t.map(l=>N(l,e,u));return l=>{for(const p of c){const C=p(l);if(C)return C}return!1}}const n=aD(t)&&t.tokens&&t.input;if(t===""||typeof t!="string"&&!n)throw new TypeError("Expected pattern to be a non-empty string");const s=e||{},r=It.isWindows(e),i=n?N.compileRe(t,e):N.makeRe(t,e,!1,!0),D=i.state;delete i.state;let o=()=>!1;if(s.ignore){const c={...e,ignore:null,onMatch:null,onResult:null};o=N(s.ignore,c,u)}const a=(c,f=!1)=>{const{isMatch:l,match:p,output:C}=N.test(c,i,e,{glob:t,posix:r}),F={glob:t,state:D,regex:i,posix:r,input:c,output:C,match:p,isMatch:l};return typeof s.onResult=="function"&&s.onResult(F),l===!1?(F.isMatch=!1,f?F:!1):o(c)?(typeof s.onIgnore=="function"&&s.onIgnore(F),F.isMatch=!1,f?F:!1):(typeof s.onMatch=="function"&&s.onMatch(F),f?F:!0)};return u&&(a.state=D),a};N.test=(t,e,u,{glob:n,posix:s}={})=>{if(typeof t!="string")throw new TypeError("Expected input to be a string");if(t==="")return{isMatch:!1,output:""};const r=u||{},i=r.format||(s?It.toPosixSlashes:null);let D=t===n,o=D&&i?i(t):t;return D===!1&&(o=i?i(t):t,D=o===n),(D===!1||r.capture===!0)&&(r.matchBase===!0||r.basename===!0?D=N.matchBase(t,e,u,s):D=e.exec(o)),{isMatch:!!D,match:D,output:o}},N.matchBase=(t,e,u,n=It.isWindows(u))=>(e instanceof RegExp?e:N.makeRe(e,u)).test(iD.basename(t)),N.isMatch=(t,e,u)=>N(e,u)(t),N.parse=(t,e)=>Array.isArray(t)?t.map(u=>N.parse(u,e)):Lt(t,{...e,fastpaths:!1}),N.scan=(t,e)=>DD(t,e),N.compileRe=(t,e,u=!1,n=!1)=>{if(u===!0)return t.output;const s=e||{},r=s.contains?"":"^",i=s.contains?"":"$";let D=`${r}(?:${t.output})${i}`;t&&t.negated===!0&&(D=`^(?!${D}).*$`);const o=N.toRegex(D,e);return n===!0&&(o.state=t),o},N.makeRe=(t,e={},u=!1,n=!1)=>{if(!t||typeof t!="string")throw new TypeError("Expected a non-empty string");let s={negated:!1,fastpaths:!0};return e.fastpaths!==!1&&(t[0]==="."||t[0]==="*")&&(s.output=Lt.fastpaths(t,e)),s.output||(s=Lt(t,e)),N.compileRe(s,e,u,n)},N.toRegex=(t,e)=>{try{const u=e||{};return new RegExp(t,u.flags||(u.nocase?"i":""))}catch(u){if(e&&e.debug===!0)throw u;return/$^/}},N.constants=oD;var lD=N,pn=lD;const we=ie,{Readable:cD}=Os,Re=K,{promisify:Ye}=me,kt=pn,fD=Ye(we.readdir),hD=Ye(we.stat),Cn=Ye(we.lstat),dD=Ye(we.realpath),ED="!",Fn="READDIRP_RECURSIVE_ERROR",pD=new Set(["ENOENT","EPERM","EACCES","ELOOP",Fn]),Mt="files",gn="directories",qe="files_directories",Xe="all",mn=[Mt,gn,qe,Xe],CD=t=>pD.has(t.code),[_n,FD]=process.versions.node.split(".").slice(0,2).map(t=>Number.parseInt(t,10)),gD=process.platform==="win32"&&(_n>10||_n===10&&FD>=5),An=t=>{if(t!==void 0){if(typeof t=="function")return t;if(typeof t=="string"){const e=kt(t.trim());return u=>e(u.basename)}if(Array.isArray(t)){const e=[],u=[];for(const n of t){const s=n.trim();s.charAt(0)===ED?u.push(kt(s.slice(1))):e.push(kt(s))}return u.length>0?e.length>0?n=>e.some(s=>s(n.basename))&&!u.some(s=>s(n.basename)):n=>!u.some(s=>s(n.basename)):n=>e.some(s=>s(n.basename))}}};class Dt extends cD{static get defaultOptions(){return{root:".",fileFilter:e=>!0,directoryFilter:e=>!0,type:Mt,lstat:!1,depth:2147483648,alwaysStat:!1}}constructor(e={}){super({objectMode:!0,autoDestroy:!0,highWaterMark:e.highWaterMark||4096});const u={...Dt.defaultOptions,...e},{root:n,type:s}=u;this._fileFilter=An(u.fileFilter),this._directoryFilter=An(u.directoryFilter);const r=u.lstat?Cn:hD;gD?this._stat=i=>r(i,{bigint:!0}):this._stat=r,this._maxDepth=u.depth,this._wantsDir=[gn,qe,Xe].includes(s),this._wantsFile=[Mt,qe,Xe].includes(s),this._wantsEverything=s===Xe,this._root=Re.resolve(n),this._isDirent="Dirent"in we&&!u.alwaysStat,this._statsProp=this._isDirent?"dirent":"stats",this._rdOptions={encoding:"utf8",withFileTypes:this._isDirent},this.parents=[this._exploreDir(n,1)],this.reading=!1,this.parent=void 0}async _read(e){if(!this.reading){this.reading=!0;try{for(;!this.destroyed&&e>0;){const{path:u,depth:n,files:s=[]}=this.parent||{};if(s.length>0){const r=s.splice(0,e).map(i=>this._formatEntry(i,u));for(const i of await Promise.all(r)){if(this.destroyed)return;const D=await this._getEntryType(i);D==="directory"&&this._directoryFilter(i)?(n<=this._maxDepth&&this.parents.push(this._exploreDir(i.fullPath,n+1)),this._wantsDir&&(this.push(i),e--)):(D==="file"||this._includeAsFile(i))&&this._fileFilter(i)&&this._wantsFile&&(this.push(i),e--)}}else{const r=this.parents.pop();if(!r){this.push(null);break}if(this.parent=await r,this.destroyed)return}}}catch(u){this.destroy(u)}finally{this.reading=!1}}}async _exploreDir(e,u){let n;try{n=await fD(e,this._rdOptions)}catch(s){this._onError(s)}return{files:n,depth:u,path:e}}async _formatEntry(e,u){let n;try{const s=this._isDirent?e.name:e,r=Re.resolve(Re.join(u,s));n={path:Re.relative(this._root,r),fullPath:r,basename:s},n[this._statsProp]=this._isDirent?e:await this._stat(r)}catch(s){this._onError(s)}return n}_onError(e){CD(e)&&!this.destroyed?this.emit("warn",e):this.destroy(e)}async _getEntryType(e){const u=e&&e[this._statsProp];if(u){if(u.isFile())return"file";if(u.isDirectory())return"directory";if(u&&u.isSymbolicLink()){const n=e.fullPath;try{const s=await dD(n),r=await Cn(s);if(r.isFile())return"file";if(r.isDirectory()){const i=s.length;if(n.startsWith(s)&&n.substr(i,1)===Re.sep){const D=new Error(`Circular symlink detected: "${n}" points to "${s}"`);return D.code=Fn,this._onError(D)}return"directory"}}catch(s){this._onError(s)}}}}_includeAsFile(e){const u=e&&e[this._statsProp];return u&&this._wantsEverything&&!u.isDirectory()}}const Ee=(t,e={})=>{let u=e.entryType||e.type;if(u==="both"&&(u=qe),u&&(e.type=u),t){if(typeof t!="string")throw new TypeError("readdirp: root argument must be a string. Usage: readdirp(root, options)");if(u&&!mn.includes(u))throw new Error(`readdirp: Invalid type passed. Use one of ${mn.join(", ")}`)}else throw new Error("readdirp: root argument is required. Usage: readdirp(root, options)");return e.root=t,new Dt(e)},mD=(t,e={})=>new Promise((u,n)=>{const s=[];Ee(t,e).on("data",r=>s.push(r)).on("end",()=>u(s)).on("error",r=>n(r))});Ee.promise=mD,Ee.ReaddirpStream=Dt,Ee.default=Ee;var _D=Ee,Wt={exports:{}};/*!
 * normalize-path <https://github.com/jonschlinkert/normalize-path>
 *
 * Copyright (c) 2014-2018, Jon Schlinkert.
 * Released under the MIT License.
 */var yn=function(t,e){if(typeof t!="string")throw new TypeError("expected path to be a string");if(t==="\\"||t==="/")return"/";var u=t.length;if(u<=1)return t;var n="";if(u>4&&t[3]==="\\"){var s=t[2];(s==="?"||s===".")&&t.slice(0,2)==="\\\\"&&(t=t.slice(2),n="//")}var r=t.split(/[/\\]+/);return e!==!1&&r[r.length-1]===""&&r.pop(),n+r.join("/")},AD=Wt.exports;Object.defineProperty(AD,"__esModule",{value:!0});const wn=pn,yD=yn,Rn="!",wD={returnIndex:!1},RD=t=>Array.isArray(t)?t:[t],bD=(t,e)=>{if(typeof t=="function")return t;if(typeof t=="string"){const u=wn(t,e);return n=>t===n||u(n)}return t instanceof RegExp?u=>t.test(u):u=>!1},bn=(t,e,u,n)=>{const s=Array.isArray(u),r=s?u[0]:u;if(!s&&typeof r!="string")throw new TypeError("anymatch: second argument must be a string: got "+Object.prototype.toString.call(r));const i=yD(r,!1);for(let o=0;o<e.length;o++){const a=e[o];if(a(i))return n?-1:!1}const D=s&&[i].concat(u.slice(1));for(let o=0;o<t.length;o++){const a=t[o];if(s?a(...D):a(i))return n?o:!0}return n?-1:!1},Gt=(t,e,u=wD)=>{if(t==null)throw new TypeError("anymatch: specify first argument");const n=typeof u=="boolean"?{returnIndex:u}:u,s=n.returnIndex||!1,r=RD(t),i=r.filter(o=>typeof o=="string"&&o.charAt(0)===Rn).map(o=>o.slice(1)).map(o=>wn(o,n)),D=r.filter(o=>typeof o!="string"||typeof o=="string"&&o.charAt(0)!==Rn).map(o=>bD(o,n));return e==null?(o,a=!1)=>bn(D,i,o,typeof a=="boolean"?a:!1):bn(D,i,e,s)};Gt.default=Gt,Wt.exports=Gt;var vD=Wt.exports;/*!
 ...
 * Released under the MIT License.
 */const $n=MD,oe=(t,e,u)=>{if($n(t)===!1)throw new TypeError("toRegexRange: expected the first argument to be a number");if(e===void 0||t===e)return String(t);if($n(e)===!1)throw new TypeError("toRegexRange: expected the second argument to be a number.");let n={relaxZeros:!0,...u};typeof n.strictZeros=="boolean"&&(n.relaxZeros=n.strictZeros===!1);let s=String(n.relaxZeros),r=String(n.shorthand),i=String(n.capture),D=String(n.wrap),o=t+":"+e+"="+s+r+i+D;if(oe.cache.hasOwnProperty(o))return oe.cache[o].result;let a=Math.min(t,e),c=Math.max(t,e);if(Math.abs(a-c)===1){let F=t+"|"+e;return n.capture?`(${F})`:n.wrap===!1?F:`(?:${F})`}let f=Pn(t)||Pn(e),l={min:t,max:e,a,b:c},p=[],C=[];if(f&&(l.isPadded=f,l.maxLen=String(l.max).length),a<0){let F=c<0?Math.abs(c):1;C=Tn(F,Math.abs(a),l,n),a=l.a=0}return c>=0&&(p=Tn(a,c,l,n)),l.negatives=C,l.positives=p,l.result=WD(C,p),n.capture===!0?l.result=`(${l.result})`:n.wrap!==!1&&p.length+C.length>1&&(l.result=`(?:${l.result})`),oe.cache[o]=l,l.result};function WD(t,e,u){let n=Kt(t,e,"-",!1)||[],s=Kt(e,t,"",!1)||[],r=Kt(t,e,"-?",!0)||[];return n.concat(r).concat(s).join("|")}function GD(t,e){let u=1,n=1,s=On(t,u),r=new Set([e]);for(;t<=s&&s<=e;)r.add(s),u+=1,s=On(t,u);for(s=Nn(e+1,n)-1;t<s&&s<=e;)r.add(s),n+=1,s=Nn(e+1,n)-1;return r=[...r],r.sort(KD),r}function jD(t,e,u){if(t===e)return{pattern:t,count:[],digits:0};let n=UD(t,e),s=n.length,r="",i=0;for(let D=0;D<s;D++){let[o,a]=n[D];o===a?r+=o:o!=="0"||a!=="9"?r+=VD(o,a):i++}return i&&(r+=u.shorthand===!0?"\\d":"[0-9]"),{pattern:r,count:[i],digits:s}}function Tn(t,e,u,n){let s=GD(t,e),r=[],i=t,D;for(let o=0;o<s.length;o++){let a=s[o],c=jD(String(i),String(a),n),f="";if(!u.isPadded&&D&&D.pattern===c.pattern){D.count.length>1&&D.count.pop(),D.count.push(c.count[0]),D.string=D.pattern+Hn(D.count),i=a+1;continue}u.isPadded&&(f=zD(a,u,n)),c.string=f+c.pattern+Hn(c.count),r.push(c),i=a+1,D=c}return r}function Kt(t,e,u,n,s){let r=[];for(let i of t){let{string:D}=i;!n&&!xn(e,"string",D)&&r.push(u+D),n&&xn(e,"string",D)&&r.push(u+D)}return r}function UD(t,e){let u=[];for(let n=0;n<t.length;n++)u.push([t[n],e[n]]);return u}function KD(t,e){return t>e?1:e>t?-1:0}function xn(t,e,u){return t.some(n=>n[e]===u)}function On(t,e){return Number(String(t).slice(0,-e)+"9".repeat(e))}function Nn(t,e){return t-t%Math.pow(10,e)}function Hn(t){let[e=0,u=""]=t;return u||e>1?`{${e+(u?","+u:"")}}`:""}function VD(t,e,u){return`[${t}${e-t===1?"":"-"}${e}]`}function Pn(t){return/^-?(0+)\d/.test(t)}function zD(t,e,u){if(!e.isPadded)return t;let n=Math.abs(e.maxLen-String(t).length),s=u.relaxZeros!==!1;switch(n){case 0:return"";case 1:return s?"0?":"0";case 2:return s?"0{0,2}":"00";default:return s?`0{0,${n}}`:`0{${n}}`}}oe.cache={},oe.clearCache=()=>oe.cache={};var YD=oe;/*!
