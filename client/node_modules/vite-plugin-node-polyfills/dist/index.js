...
const c = (e) => e ? e === !0 ? !0 : e === "build" : !1, u = (e) => e ? e === !0 ? !0 : e === "dev" : !1, $ = (e) => e.startsWith("node:"), E = (e) => e.replace(/^node:/, ""), q = (e = {}) => {
  ...
  }, d = (o, s) => o === s || o === `node:${s}`, m = (o) => r.include.length ? !r.include.some((s) => d(o, s)) : r.exclude.some((s) => d(o, s)), v = (o) => {
  ...
  return {
    ...
    config: (o, s) => {
      const n = s.command === "serve", b = Object.entries(x).reduce((t, [l, p]) => (!r.protocolImports && $(l) || m(l) || (t[l] = v(E(l)) || p), t), {});
      return {
        build: {
          rollupOptions: {
            onwarn: (t, l) => {
              P(t, l), o.build?.rollupOptions?.onwarn?.(t, l);
            },
            plugins: [
              {
                ...y({
          ...
          esbuildOptions: {
            ...
            plugins: [
              ...
              // https://github.com/evanw/esbuild/blob/edede3c49ad6adddc6ea5b3c78c6ea7507e03020/internal/bundler/bundler.go#L1469
              {
                ...
                setup(t) {
                  const l = i.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), p = new RegExp(`^${l}$`);
