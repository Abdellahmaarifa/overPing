...
let ReadyFriend = ( {playerOne, playerTwo, updateReadyState , updateUserInfoWagerAndMode, updateUserInfoWagerAndModeTwo , updateMatchId, updatePlayerTwo} : readyProps) =>
{
