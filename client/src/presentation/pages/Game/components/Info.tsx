...
function Info({
  ...
  useEffect(() => {
    ...
    const intervalId = setInterval(
      () => sendDataToServer(playerOne.matchId, playerOne.tabId),
      499
    );
  ...
  setTimeout(() => {
    ...
    let leftImgInfo: HTMLElement | null =
      document.getElementById("infoAvatar1");
    let rightImg: HTMLElement | null = document.getElementById("infoAvatar02");
    let rightImgInfo: HTMLElement | null =
      document.getElementById("infoAvatar2");
  ...
  return (
    <div id="muteBtn" className="playersInfo">
      <div
        className={`container0 ${hovered1 ? "hideContainer0" : ""}  ${
          hovered2 ? "hideContainer0" : ""
        }`}
      >
        <div className="head0"></div>

        <div className="middle0">
          <span className="leftCurve">
            <p>{leftGoal}</p>
          </span>
          <div className="playersContainer">
            <div className="infoPlayers">
              <div className="infoPlayer01">
                <div
                  className="hoverExpand1"
                  onClick={() => {
                    if (playerOne.playWithRobot === false) setHovered1(true);
                  }}
                >
                  <div className="infoAvatar01">
                    <img
                      id="infoAvatar01"
      ...
      <div className={` container1 ${hovered1 ? "displayContainer1" : ""} `}>
        ...
        <div className="middle1">
          <span className="leftCurvePlayer1">
            <p>{leftGoal}</p>
          </span>
          <div className="player1Container">
            <div className="info1">
              <div className="avatar1Border">
                <div
                  className="info1Avatar1"
                  onClick={() => setHovered1(false)}
                >
                  <img
                    id="infoAvatar1"
                    src={playerTwo.userAvatar}
                    alt="imgA"
                  ></img>
                </div>
              </div>
                ...
                <div className="shields">
                  ...
                  <span className="shld">
                    <center>
                      matches loss
                      <br />
                      {playerTwo.tournentPlayed}
                    </center>
                  </span>
                </div>
              </div>
              <div className="team">
                <img id="leftTeam" src={playerTwo.userLogo} alt="badge" />
              </div>
            </div>
          ...
          <span className="rightCurvePlayer1">
            <p>{rightGoal}</p>
          </span>
        </div>
      </div>
      ...
      <div className={` container2 ${hovered2 ? "displayContainer2" : ""} `}>
        ...
        <div className="middle2">
          <span className="leftCurvePlayer2">
            <p>{rightGoal}</p>
          </span>
          <div className="player2Container">
            <div className="info2">
              <div className="avatar1Border">
                <div
                  className="info2Avatar2"
                  onClick={() => setHovered2(false)}
                >
                  <img
                    id="infoAvatar2"
                    src={playerOne.userAvatar}
                    alt="imgA"
                  ></img>
                </div>
              </div>
              ...
              <div className="team">
                <img id="rightTeam" src={playerTwo.userLogo} alt="badge" />
              </div>
            </div>
          ...
          <span className="rightCurvePlayer2">
            <p>{leftGoal}</p>
          </span>
        </div>
      </div>
