...
class SoundsClass
{
    ...
    displayRacketReboundSound = (gameCapsule : GameContainer, game : Game, ballX : number , ballY : number, ballWH : number ) =>
    {
        if (gameCapsule.init && ballX  - ballWH < (game.p5.width / 80) && this.isTap === 0 && gameCapsule.ball.ballDirection !== undefined) 
        {
        ...
        else if (gameCapsule.init && ballX + ballWH > game.p5.width - (game.p5.width / 80) && this.isTap === 0 && gameCapsule.ball.ballDirection !== undefined)
        {
          if (ballY > game.rightRacket.racketY && ballY < game.rightRacket.racketY + game.rightRacket.racketH)
          {
            this.racketSound.play();
    ...
    {
        if (ballWH && (ballY + ballWH >= game.p5.height || ballY - ballWH <= 0) && this.isHitTopOrButtom === 0)
        {
