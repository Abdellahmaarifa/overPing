...
let Util = ({ playerOne , updateUserInfoUtil, updatePlayerOne} : UtilProps ) =>
{
    ...
    else
    {
        ...
        if (playerOne.userLogo.length === 0)
        {
            updatePlayerOne(p1.playWithRobot, p1.tabId, p1.matchId, p1.matchWager, p1.modePlaying, p1.userName,
                ...
                p1.tournentPlayed, p1.tournentWon, p1.playWithMouse,p1.userId);
        } 
        return (
