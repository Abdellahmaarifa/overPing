...
export const MobileMenu = styled(motion.div)(({ isOpen }: any) => [
  tw`md:hidden bg-main fixed top-0 left-0 w-full h-full flex flex-col items-center p-4 space-y-4 transform transition-transform duration-300 ease-in-out`,
