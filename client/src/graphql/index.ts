...
export type HomeQuery = { __typename?: 'Query', home: string };
...
export type UserQuery = { __typename?: 'Query', user: { __typename?: 'UserResponse', id: string, email: string, userName: string, profilePhoto: string } };
