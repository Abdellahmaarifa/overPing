...
export const FriendsMatchesConatiner = tw.div`
  w-full h-fit min-h-[400px] bg-[#0E1821] rounded-[4px] rounded-tl-[16px] rounded-tr-[16px] flex justify-start items-center gap-[16px] flex-col min-w-[300px] p-[16px] max-h-[500px] overflow-scroll relative
`;
