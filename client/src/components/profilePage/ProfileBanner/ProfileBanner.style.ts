...
bg-center bg-cover
      min-w-[300px] w-full h-[172px] rounded-bl-[14px] rounded-br-[14px] md:rounded-[16px] relative overflow-hidden max-w-[1126px] md:h-[256px]
`;

export const BannerMenuConatiner = tw.div`
w-full h-[40px] md:h-[53px] absolute bottom-0 left-0  flex justify-end items-center p-[12px] md:p-[24px] gap-[12px] md:gap-[16px]
`;

export const BannerMenuMask = tw.div`
w-[770px] max-w-full min-w-[770px] md:min-w-[1126px] h-full  bg-profile-gradient absolute left-[0px] opacity-[.9]
